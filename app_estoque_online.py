...
def carregar_componentes_visuais():
    ...
    <style>
        ...
        .sidebar-header {{ text-align: left; margin-bottom: 2rem; display: flex; align-items: center;}}
        .sidebar-icon {{ 
            font-size: 1.5em; color: #e0e0e0; background-color: #2e2e54; 
            border-radius: 50%; width: 40px; height: 40px; 
            display: inline-flex; align-items: center; justify-content: center;
            margin-right: 12px;
        }}
        .sidebar-menu {{ flex-grow: 1; }}
        .sidebar-footer {{ text-align: left; color: #a9a9a9; padding-top: 1rem; }}
...
with st.sidebar:
    st.markdown('<div class="sidebar-header"><i class="fa-solid fa-pen-nib sidebar-icon"></i><h3>Studio Stock</h3></div>', unsafe_allow_html=True)
    ...
    st.markdown('<div class="sidebar-footer"><span class="footer-brand">Feito para estúdios modernos.</span><span class="footer-version">Versão 1.0</span></div>', unsafe_allow_html=True)
